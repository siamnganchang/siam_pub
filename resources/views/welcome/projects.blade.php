<x-guest-layout>
  <br>
    <main>
        ...
        <div class="flex flex-col my-6 mx-4  shadow-xl shadow-gray-50">
                    ...
                    <div class="overflow-hidden shadow-lg">
                        <section>
                            <header class="bg-white space-y-4 p-4 sm:px-8 sm:py-6 lg:p-4 xl:px-8 xl:py-6">
                                ...
                                <form class="flex items-center"  method="POST" action="{{route('ownwork.index')}}">   
                                    @csrf
                                    @method('GET')
                                    ...
                                    <div class="relative w-full">
                                        ...
                                        <input type="text" name="search" value="{{ request()->get('search') }}"  id="products-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." required>
                                    </div>
                                    <button type="submit" class="inline-flex items-center py-2.5 px-3 ml-2 text-sm font-medium text-white rounded-lg border focus:ring-4 focus:outline-none  bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-red-300 dark:focus:ring-red-800 shadow-lg shadow-red-500/50 dark:shadow-lg dark:shadow-red-800/80">
                                        <svg aria-hidden="true" class="w-5 h-5 mr-2 -ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>ค้นหา
                                    </button>
                                </form>
                            ...
                            <ul class="p-4 sm:px-8 sm:pt-6 sm:pb-8 lg:p-4 xl:px-8 xl:pt-6 xl:pb-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4 text-sm leading-6">
                              @foreach ($works as $work)
                                <li >
                                    <a href="{{route('ownwork.show',$work->id)}}">
                                        <dl>
                                            <div class="container shadow-xl rounded-xl tracking-in-expand-fwd-bottom " style="padding: 20px">


                                                <div class="flex justify-center items- ncenter pb-4 ">
                                                  @foreach($work->images as $img)
                                                    @if($loop->first)
                                                    <img class="bg-contain rounded-md aspect-1 boxWork"  src="{{$img->image_path}}" alt="attachment">
                                                    @endif
                                                  @endforeach
                                                </div>
                                                ...
                                                <div class="flex flex-col">
                                                    ...
                                                    <div class="flex justify-between">
                                                        ...
                                                        <div class="flex mt-3 justify-center items-center px-3 text-xs font-bold uppercase text-gray-600 rounded-2xl ">
