<aside id="sidebar" class="flex hidden fixed top-0 left-0 z-20 shadow-2xl flex-shrink-0 pt-16 w-64 h-full duration-200 lg:flex transition-width lg:w-64"
            aria-label="Sidebar">
            <div class="flex relative flex-col flex-1 pt-0 min-h-0 bg-gray-50">
                    ...
                    <div class="flex-1 bg-gray-50 px-3" id="sidebar-items">
                        <ul class="pb-2 pt-1">
                            ...
                            <li>
                                <a href="{{url('/ownwork')}}"
                                    ...
                                    <span class="ml-3 text-dark-500 text-sm font-light"
                                        sidebar-toggle-item="">Projects</span>
                                </a>
                            </li>
                            <li>
                                <button type="button"
                                    ...
                                    <svg sidebar-toggle-item="" class="w-4 h-4 ml-auto text-gray-700"
                                ...
                                <ul id="dropdown-ecommerce" sidebar-toggle-list="" class="pb-2 pt-1 hidden">
                                    <li>
                                        <a href="#/e-commerce/products/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Products</span><span class="hidden">P</span></a>
                                    </li>
                                    <li>
                                        <a href="#/e-commerce/billing/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Billing</span><span class="hidden">B</span></a>
                                    </li>
                                    <li>
                                        <a href="#/e-commerce/invoice/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Invoice</span><span class="hidden">I</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul id="dropdown-users" sidebar-toggle-list="" class="pb-2 pt-1 hidden">
                                    <li>
                                        <a href="#/users/list/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Users list</span><span class="hidden">U</span></a>
                                    </li>
                                    <li>
                                        <a href="#/users/profile/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Profile</span><span class="hidden">P</span></a>
                                    </li>
                                    <li>
                                        <a href="#/users/settings/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Settings</span><span class="hidden">S</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul id="dropdown-pages" sidebar-toggle-list="" class="pb-2 pt-1 hidden">
                                    <li>
                                        <a href="#/pages/pricing/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Pricing</span><span class="hidden">P</span></a>
                                    </li>
                                    <li>
                                        <a href="#/pages/maintenance/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Maintenance</span><span class="hidden">M</span></a>
                                    </li>
                                    <li>
                                        <a href="#/pages/404/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">404 not found</span><span class="hidden">4</span></a>
                                    </li>
                                    <li>
                                        <a href="#/pages/500/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">500 server error</span><span
                                                class="hidden">5</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                ...
                                <ul id="dropdown-auth" sidebar-toggle-list="" class="pb-2 pt-1 hidden">
                                    <li>
                                        <a href="#/authentication/sign-in/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Sign in</span><span class="hidden">S</span></a>
                                    </li>
                                    <li>
                                        <a href="#/authentication/sign-up/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Sign up</span><span class="hidden">S</span></a>
                                    </li>
                                    <li>
                                        <a href="#/authentication/forgot-password/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Forgot password</span><span class="hidden">F</span></a>
                                    </li>
                                    <li>
                                        <a href="#/authentication/reset-password/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Reset password</span><span class="hidden">R</span></a>
                                    </li>
                                    <li>
                                        <a href="#/authentication/profile-lock/"
                                            class="text-sm text-dark-500 font-light rounded-lg flex items-center p-2 group hover:bg-gray-200 transition duration-75 pl-11"><span
                                                class="">Profile lock</span><span class="hidden">P</span></a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        ...
                        <div class="pt-2">
                            <a href="#" target="_blank"
                                ...
                                <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item="">Buy
                                    now</span>
                            </a>
                            <a href="{{url('/about')}}"
                                class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200"
                                ...
                                <span class="ml-3 text-dark-500 text-sm font-light" sidebar-toggle-item="">About us</span>
                            </a>
                            <a href="#"
                                target="_blank"
                                class="flex items-center py-2.5 px-4 text-base font-normal text-dark-500 rounded-lg hover:bg-gray-200 group transition-all duration-200"
                ...
                <div class="hidden relative bottom-0 left-0 justify-center w-full lg:flex bg-gray-100 space-x-4 p-4"
                    sidebar-bottom-menu="">
                </div>
            </div>
        </aside>