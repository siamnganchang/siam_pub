<!-- Edit Work modal -->
<div id="AddWorkModal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center p-4 w-full md:inset-0 h-modal md:h-full">
    <div class="relative w-full max-w-2xl h-full md:h-auto">
        <!-- Modal content -->
        <form action="{{route('work.store')}}" method="POST" enctype="multipart/form-data" class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            @csrf
            <!-- Modal header -->
            <div class="flex justify-between items-start p-4 rounded-t border-b dark:border-gray-600">
                ...
                <a  href="{{route('work.index')}}" class=" text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="AddWorkModal">
            ...
            <div class="p-6 space-y-6 ">
                <div class="grid grid-cols-6 gap-3">
                    <div class="col-span-12 sm:col-span-6">
                        ...
                        <input type="text" name="title" id="title" required class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="หัวข้อ" >
                    </div>
                    <div class="col-span-12 sm:col-span-6">
                        <label for="company" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Company</label>
                        <input type="text" name="company" id="company" required class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="บริษัท/หน่วยงาน/ผู้ว่าจ้าง" >
                    </div>

      
                        <input id="images" type="file" name="imageFile[]" multiple="multiple" accept=".png, .jpg, .jpeg" class="hidden">   


                    <!---------------------form Text -------------------------->

                    <div class="col-span-12 sm:col-span-6 scroll-ml-2">   
                        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                            <div class="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
                                <div class="flex flex-wrap items-center divide-gray-200 sm:divide-x dark:divide-gray-600">
                                    <div class="flex items-center space-x-1 sm:pr-4">
                                        ...
                                        <label  for="images" class="p-2 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
                            ...
                            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                                ...
                                <div id="description" rows="8" class="imgPreview grid grid-cols-4 gap-4"></div>
                                <textarea  id="description" name="description" rows="8" class=" w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="รายละเอียด..." required></textarea >
                            </div>
                        </div>
