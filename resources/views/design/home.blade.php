    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            {{-- <h1>Title : <span class="text-primary text-2xl mt-3">{{ $works->title }}</span> </h1> --}}
            <br>
            <a href="{{ url('/') }}"
                class="text-white mt-5 ml-4 bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                ดูตัวอย่าง</a>

            <h3 class="mb-4 text-xl font-extrabold text-gray-900 dark:text-white md:text-2xl lg:text-2xl mt-5 ml-4"><span
                    class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">SIAM
                    NGANCHANG</span> (2551).</h3>
            <p class="text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400 ml-4">ข้อมูลนี้จะแสดงที่หน้า Home
            </p>
        ...
        <form action="{{route('design.store')}}" method="POST" class="mt-2" enctype="multipart/form-data">
            @csrf
            @method('POST')
  ...
  <div class="relative w-full max-w-md h-full md:h-auto">
      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="p-6 text-center">
              ...
              <form method="POST" action="{{route('design.deleteFile')}}">
                @csrf
      ...
      <div class="splide__track">
        <ul class="splide__list">
          <li class="splide__slide ">
            <img
              src="images/slider-1.jpg" class="rounded-lg  dark:shadow-gray-800"
              alt=""
            />
          </li>
          <li class="splide__slide">
            <img
              src="images/slider-2.jpg" class="rounded-lg  dark:shadow-gray-800"
              alt=""
            />
          </li>
          <li class="splide__slide">
            <img
              src="images/slider-3.jpg" class="rounded-lg  dark:shadow-gray-800"
              alt=""
            />
          </li>
